    ...
    <div class="form-floating my-2">
        <select name="idu" {{-- <-- Nombre del Campo --}} id="role_select" class="form-select form-control" autocomplete="off"
               value="{{ $items[0]->idu }}" placeholder="Seleccione el nombre del profesor" required>
            ...
            <option value="{{$name->idu}}" @if($name->idu==$items[0]->idu)selected @endif>{{$name->nombre}} {{$name->apellido_paterno}} {{$name->apellido_materno}}</option>
            @endforeach
        </select>
