        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 bg-primario rounded-top mb-3">
                <div class="col-12 py-4">
                    <h1 class="text-white fw-bold text-uppercase text-center fs-4 mb-2">Crear Nueva Libro</h1>
            ...
            <!-- Form -->
            <form action="{{ route('libro.store') }}" class="form" method="POST">
                @csrf
                @method('POST')
                        ...
                        <div class="col-12 col-lg-10">
                            ...
                            <div class="form-floating my-2">
                                <input
                                    ...
                                    id="input-text"
                                    required>
                                <label for="input-text">Nombre de libro</label>
                            ...
                            <!-- Input Select -->
                            <div class="form-floating my-2">
                                <select name="idca" {{-- <-- Nombre del Campo --}} id="idca" class="form-select form-control" autocomplete="off" value="{{ old( 'idca' ) }}" placeholder="Carrera" required>
                                    <option value="" selected disabled>-- Seleccione una Carrera --</option>
                                     @foreach($carreras as $c)
                                     <option value="{{$c->idca}}">{{$c->nombre}}</option>
                                     @endforeach
                                </select>
                                <label for="input-text">Carrera</label>
                ...
                <div class="d-flex justify-content-end mt-5">
                    <a title="Regresar" href="{{ route('libro.index') }}" class="text-end fs-6 text-secundario"><img src="{{ asset('img/regresa.jpg')}}" width="30" height="30"></a>
                </div>
            </form>
            <!-- Form End -->
        </div>
