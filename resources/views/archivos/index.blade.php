...
<div class="container-fluid p-0">
    ...
    <div class="col-12 bg-primario rounded-top mb-3">
        <div class="col-12 py-4">
            <h1 class="text-white fw-bold text-uppercase text-center fs-4 mb-2">Control de archivos</h1>
        </div>
    </div>
    <!-- Container Slogan -->
    ...
    <div class="row w-100 h-100 m-0 p-0">
        ...
        <!-- Header Section -->
        <form action="{{ route('archivos.index') }}" method="POST" class="row w-100 p-0 mx-auto align-items-center" id="form-number-items">
            ...
            <div class="col-12 col-md-4">
                <a href="{{ route('archivos.create') }}" class="btn btn-primario text-white btn-sm d-block mx-auto w-75">Agregar documentos</a>
            </div>
        </form>
        <!-- Header Section -->
                              ...
                              {{--  start botón de editar --}}
                                <div class="row justify-content-evenly w-100">
                                    <div class="col text-center px-0">
                                        <a href="{{ route('archivos.edit', $item) }}" class="btn btn-sm btn-primario text-white w-20" >
                                    ...
                                    <div class="col text-center px-0">
                                        <form action="{{ route('archivos.toggle.status', $item) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                    ...
                                    <div class="col text-center px-0">
                                        @if(!$item->activo)
                                        <form action="{{ route('archivos.destroy', $item) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col text-center">
                        <a href="{{ route('archivos.edit', $item) }}" class="btn btn-sm btn-primario text-white">Editar</a>
                    </div>
                    <div class="col text-center">
                        <form action="{{ route('archivos.toggle.status', $item) }}" method="POST">
                            @csrf
