...
<div class="container-fluid p-0">
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <form action="{{ route('archivos.store') }}" class="form" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST')
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-lg-10">
                            ...
                            <div class="form-floating my-2 boton">
                                <label class="boton__doc" for="input-text"><i class='bx bxs-file-pdf boton__pdf'></i> Suba el documento de la cédula profesional<i class='boton__upload bx bx-upload bx-burst bx-flip-horizontal' ></i></label>
                                <input
                                    @class(['form-control boton__documento'=> !$errors->first('ruta'), 'form-control is-invalid' => $errors->first('ruta')])
                                    autocomplete="off"
                                    type="file"
                                    value="{{ old( 'ruta' ) }}"
