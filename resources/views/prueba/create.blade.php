        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 bg-primario rounded-top mb-3">
                <div class="col-12 py-4">
                    <h1 class="text-white fw-bold text-uppercase text-center fs-4 mb-2">Crear Nueva Prueba</h1>
            ...
            <!-- Form -->
            <form action="{{ route('prueba.store') }}" class="form" method="POST">
                @csrf
                @method('POST')
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-lg-10">
                            ...
                            <div class="form-floating my-2">
                                <input
                                    @class(['form-control'=> !$errors->first('name'), 'form-control is-invalid' => $errors->first('name')])
                                    autocomplete="off"
                                    type="text"
                                    value="{{ old( 'name' ) }}"
                            ...
                            <div class="form-floating my-2">
                                <select name="role" {{-- <-- Nombre del Campo --}} id="role_select" class="form-select form-control" autocomplete="off" value="{{ old( 'role' ) }}" placeholder="Cargo" required>
                                    <option value="0" selected disabled>-- Seleccione un Cargo --</option>
                            ...
                            <div class="form-check my-2">
                                <div class="row items-center justify-content-center">
                                    ...
                                    <div class="col-6 d-md-flex justify-content-center">
                                        <div>
                                            <input class="form-check-input mx-auto" name="gender"{{-- <-- Nombre del Campo --}} type="radio" id="opcion-1" value="M" required>
                                    ...
                                    <div class="col-6 d-md-flex justify-content-center">
                                        <div>
                                            <input class="form-check-input mx-auto" name="gender"{{-- <-- Nombre del Campo --}} type="radio" id="opcion-2" value="F" required>
