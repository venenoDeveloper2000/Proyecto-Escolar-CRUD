        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 bg-primario rounded-top mb-3">
                <div class="col-12 py-4">
                    <h1 class="text-white fw-bold text-uppercase text-center fs-4 mb-2">Crear Nueva Materia</h1>
            ...
            <!-- Form -->
            <form action="{{ route('materiasCarreras.store') }}" class="form" method="POST">
                @csrf
                @method('POST')
                        ...
                        <div class="col-12 col-lg-10">
                            ...
                            <div class="form-floating my-2">
                                <select name="idc" {{-- <-- Nombre del Campo --}} id="role_select" class="form-select form-control" autocomplete="off"
                                    ...
                                    <option value="" selected disabled>-- Seleccione una cuatrimestre --</option>
